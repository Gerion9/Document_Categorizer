...
export function AnimatedChecklist({ className = "w-10 h-10" }: Props) {
  return (
    ...
    >
      <defs>
        <linearGradient id="check-gradient" x1="100%" y1="0%" x2="0%" y2="100%">
      ...
      <motion.g variants={{ animate: { y: [0, -3, 0], transition: { duration: 4, repeat: Infinity, ease: "easeInOut" } } }}>
        <line x1="45" y1="45" x2="70" y2="45" stroke="#d1d5db" strokeWidth="4" strokeLinecap="round" />
      </motion.g>
      ...
      />
      <motion.g variants={{ animate: { y: [0, -3, 0], transition: { duration: 4, repeat: Infinity, ease: "easeInOut" } } }}>
        <line x1="45" y1="60" x2="65" y2="60" stroke="#d1d5db" strokeWidth="4" strokeLinecap="round" />
      </motion.g>

      {/* Item 3 */}
      <motion.circle cx="35" cy="75" r="4" fill="#d1d5db" variants={{ animate: { y: [0, -3, 0], transition: { duration: 4, repeat: Infinity, ease: "easeInOut" } } }} />
      <motion.g variants={{ animate: { y: [0, -3, 0], transition: { duration: 4, repeat: Infinity, ease: "easeInOut" } } }}>
        <line x1="45" y1="75" x2="75" y2="75" stroke="#d1d5db" strokeWidth="4" strokeLinecap="round" />
      </motion.g>
