...
export function AnimatedAIBot({ className = "w-6 h-6" }: Props) {
  return (
    ...
    >
      <defs>
        <linearGradient id="ai-glow" x1="100%" y1="0%" x2="0%" y2="100%">
      ...
      <motion.circle
        ...
        variants={{
          ...
          hover: { rotate: 360, scale: 1.05, strokeWidth: 4.5, filter: "url(#glow-blur)", transition: { duration: 4, repeat: Infinity, ease: "linear" } }
        }}
